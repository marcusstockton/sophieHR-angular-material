...
export class NotesClient implements INotesClient {
    ...
    protected processPostNotes(response: HttpResponseBase): Observable<NoteDetailDto> {
        ...
        if (status === 201) {
            ...
            let result201: any = null;
            let resultData201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result201 = NoteDetailDto.fromJS(resultData201);
            return _observableOf(result201);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class UserTokens implements IUserTokens {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.expiredTime = _data["expiredTime"] ? new Date(_data["expiredTime"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["expiredTime"] = this.expiredTime ? this.expiredTime.toISOString() : undefined as any;
        data["role"] = this.role;
...
export class EmployeeListDto implements IEmployeeListDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.startOfEmployment = _data["startOfEmployment"] ? new Date(_data["startOfEmployment"].toString()) : undefined as any;
            this.address = _data["address"] ? EmployeeAddress.fromJS(_data["address"]) : undefined as any;
            this.departmentId = _data["departmentId"];
            this.companyId = _data["companyId"];
            this.department = _data["department"] ? DepartmentIdNameDto.fromJS(_data["department"]) : undefined as any;
            this.company = _data["company"] ? CompanyIdNameDto.fromJS(_data["company"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["startOfEmployment"] = this.startOfEmployment ? this.startOfEmployment.toISOString() : undefined as any;
...
export class CompanyDetailNoLogo implements ICompanyDetailNoLogo {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.updatedDate = _data["updatedDate"] ? new Date(_data["updatedDate"].toString()) : undefined as any;
            this.name = _data["name"];
            this.address = _data["address"] ? AddressBasic.fromJS(_data["address"]) : undefined as any;
        }
    }
...
export class CompanyDetailDto implements ICompanyDetailDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.address = _data["address"] ? CompanyAddress.fromJS(_data["address"]) : undefined as any;
        }
    }
...
export class CompanyCreateDto implements ICompanyCreateDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.address = _data["address"] ? AddressCreateDto.fromJS(_data["address"]) : undefined as any;
        }
    }
...
export class PostcodeLookup implements IPostcodeLookup {
    ...
    init(_data?: any) {
        if (_data) {
            this.status = _data["status"];
            this.result = _data["result"] ? Result.fromJS(_data["result"]) : undefined as any;
        }
    }
...
export class Result implements IResult {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.codes = _data["codes"] ? Codes.fromJS(_data["codes"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["ccg"] = this.ccg;
        data["nuts"] = this.nuts;
        data["codes"] = this.codes ? this.codes.toJSON() : undefined as any;
        return data;
    }
}
...
export class Company extends Base implements ICompany {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.companyConfig = _data["companyConfig"] ? CompanyConfig.fromJS(_data["companyConfig"]) : undefined as any;
        }
    }
    ...
    override toJSON(data?: any) {
        ...
        data["companyConfig"] = this.companyConfig ? this.companyConfig.toJSON() : undefined as any;
        super.toJSON(data);
        return data;
    }
}
...
export class Employee extends ApplicationUser implements IEmployee {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.dateOfBirth = _data["dateOfBirth"] ? new Date(_data["dateOfBirth"].toString()) : undefined as any;
            this.startOfEmployment = _data["startOfEmployment"] ? new Date(_data["startOfEmployment"].toString()) : undefined as any;
            this.endOfEmployment = _data["endOfEmployment"] ? new Date(_data["endOfEmployment"].toString()) : undefined as any;
            ...
            this.address = _data["address"] ? EmployeeAddress.fromJS(_data["address"]) : undefined as any;
            this.manager = _data["manager"] ? Employee.fromJS(_data["manager"]) : undefined as any;
            this.department = _data["department"] ? Department.fromJS(_data["department"]) : undefined as any;
            this.company = _data["company"] ? Company.fromJS(_data["company"]) : undefined as any;
            this.avatar = _data["avatar"] ? EmployeeAvatar.fromJS(_data["avatar"]) : undefined as any;
    ...
    override toJSON(data?: any) {
        ...
        data["dateOfBirth"] = this.dateOfBirth ? this.dateOfBirth.toISOString() : undefined as any;
        data["startOfEmployment"] = this.startOfEmployment ? this.startOfEmployment.toISOString() : undefined as any;
        data["endOfEmployment"] = this.endOfEmployment ? this.endOfEmployment.toISOString() : undefined as any;
        ...
        data["address"] = this.address ? this.address.toJSON() : undefined as any;
        data["manager"] = this.manager ? this.manager.toJSON() : undefined as any;
        data["department"] = this.department ? this.department.toJSON() : undefined as any;
        data["company"] = this.company ? this.company.toJSON() : undefined as any;
...
export class EmployeeDetailDto implements IEmployeeDetailDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.departmentId = _data["departmentId"];
            this.employeeAvatarId = _data["employeeAvatarId"];
            this.avatar = _data["avatar"] ? EmployeeAvatarDetail.fromJS(_data["avatar"]) : undefined as any;
            this.department = _data["department"] ? DepartmentIdNameDto.fromJS(_data["department"]) : undefined as any;
            this.company = _data["company"] ? CompanyIdNameDto.fromJS(_data["company"]) : undefined as any;
            this.address = _data["address"] ? EmployeeAddress.fromJS(_data["address"]) : undefined as any;
        }
...
export class EmployeeCreateDto implements IEmployeeCreateDto {
    ...
    toJSON(data?: any) {
        ...
        data["startOfEmployment"] = this.startOfEmployment ? formatDate(this.startOfEmployment) : undefined as any;
        data["address"] = this.address ? this.address.toJSON() : undefined as any;
        data["departmentId"] = this.departmentId;
        data["companyId"] = this.companyId;
        data["passportNumber"] = this.passportNumber;
